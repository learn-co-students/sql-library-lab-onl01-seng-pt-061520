...
INSERT INTO characters
    (id, name, motto, species, author_id)
VALUES
    (5, "Darrow", "motto one", "Red/Gold", 2),
    (6, "Sevro", "Shit escalates", "Gold/Red", 2),
    (7, "Mustang", "Hic Sunt Leones - Here Be Lions", "Gold", 2),
    (8, "Pax Au Telemanous", "Pax Au Telemanous", "Telemanous", 2);
